...
{
    internal abstract class RootConnectionLoaderFieldBase<TThis, TChildLoader, TChildEntity, TExecutionContext> :
        RootLoaderFieldBase<
            TThis,
        ...
        where TThis : RootConnectionLoaderFieldBase<TThis, TChildLoader, TChildEntity, TExecutionContext>
    {
        ...
        protected RootConnectionLoaderFieldBase(
            MethodCallConfigurationContext fieldConfigurator,
