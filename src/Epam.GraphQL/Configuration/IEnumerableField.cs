...
namespace Epam.GraphQL.Configuration
{
        ...
        : IWhereableField<TThis, TSourceType>
    {
        ...
        IVoid FirstOrDefault(Expression<Func<TSourceType, bool>>? predicate = null);
    }

    public interface IEnumerableField<TEntity, TSourceType, TExecutionContext>
        : IEnumerableField<IEnumerableField<TEntity, TSourceType, TExecutionContext>, TEntity, TSourceType, TExecutionContext>
    {
    }
}
