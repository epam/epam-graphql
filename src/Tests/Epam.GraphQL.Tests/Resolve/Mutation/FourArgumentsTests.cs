...
namespace Epam.GraphQL.Tests.Resolve.Mutation
{
    ...
    public class FourArgumentsTests : ResolveMutationTestBase
    {
        ...
        private IResolvableMutationFieldMixin<TArg1, TArg2, TArg3, TArg4, TestUserContext> CreateArgumentBuilder<TArg1, TArg2, TArg3, TArg4>(Mutation<TestUserContext> mutation)
        {
            return _argumentType switch
            {
