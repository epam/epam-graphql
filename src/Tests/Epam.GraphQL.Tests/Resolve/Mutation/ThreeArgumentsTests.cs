...
namespace Epam.GraphQL.Tests.Resolve.Mutation
{
    ...
    public class ThreeArgumentsTests : ResolveMutationTestBase
    {
        private readonly ArgumentType _argumentType;

        public ThreeArgumentsTests(ArgumentType argumentType)
        {
            _argumentType = argumentType;
        }

        [Test(Description = "Manual mutation/Field/Func<string, string, string, IEnumerable<Person>>")]
        public void TestReturnsEnumerable()
        {
            var manualMutation = FuncSubstitute.For<TestUserContext, string, string, string, IEnumerable<Person>>((ctx, arg1, arg2, arg3) =>
                new[]
                {
            ...
            TestMutation(
                ...
                mutationBuilder: mutation =>
                {
                    ...
                    CreateArgumentBuilder<string, string, string>(mutation)
                        .Resolve(manualMutation);
                },
                query: $@"
                    mutation {{
                        manualMutation({BuildArguments("Test", "Test2", "Test3")}) {{
                            people {{
                                id
                                payload {{
                                    id
            ...
            DataContext
                .Received()
                .AddRange(Arg.Is<IEnumerable<Person>>(p => p.First().Id == 7 && p.First().FullName == "Test Test2 Test3"));

            DataContext
                .Received(1)
                .SaveChangesAsync();

            manualMutation.HasBeenCalledOnce(arg2: s => s == "Test", arg3: s => s == "Test2", arg4: s => s == "Test3");
        }

        [Test(Description = "Manual mutation/Field/Func<string, string, string, Task<IEnumerable<Person>>>")]
        public void TestReturnsEnumerableTask()
        {
            var manualMutation = FuncSubstitute.For<TestUserContext, string, string, string, Task<IEnumerable<Person>>>(async (ctx, arg1, arg2, arg3) =>
            {
                await Task.Yield();
                return new[]
                {
        ...
        [Test(Description = "Manual mutation/Hook/Field/Func<string, string, string, IEnumerable<Person>>")]
        ...
        [Test(Description = "Manual mutation/Field/Func<string, string, string, MutationResult<string>>")]
        public void TestReturnsMutationResult()
        {
            var manualMutation = FuncSubstitute.For<TestUserContext, string, string, string, MutationResult<string>>((ctx, arg1, arg2, arg3) =>
                MutationResult.Create(ctx.DataContext.GetQueryable<Person>().Take(1), arg1 + " " + arg2 + " " + arg3));
        ...
        [Test(Description = "Manual mutation/Field/Func<string, string, string, Task<MutationResult<string>>>")]
        public void TestReturnsMutationResultTask()
        {
            var manualMutation = FuncSubstitute.For<TestUserContext, string, string, string, Task<MutationResult<string>>>(async (ctx, arg1, arg2, arg3) =>
            {
                await Task.Yield();
                return MutationResult.Create(ctx.DataContext.GetQueryable<Person>().Take(1), arg1 + " " + arg2 + " " + arg3);
            });
        ...
        [Test(Description = "Manual mutation/Field/Func<string, string, string, CustomObject<string>>/Config")]
        public void TestTypeParamReturnsConfigurableResult()
        {
            var manualMutation = FuncSubstitute.For<TestUserContext, string, string, string, CustomObject<string>>((ctx, arg1, arg2, arg3) =>
        ...
        [Test(Description = "Manual mutation/Field/Func<string, string, string, Task<CustomObject<string>>>/Config")]
        public void TestTypeParamReturnsConfigurableResultTask()
        {
            var manualMutation = FuncSubstitute.For<TestUserContext, string, string, string, Task<CustomObject<string>>>(async (ctx, arg1, arg2, arg3) =>
            {
                await Task.Yield();
                return CustomObject.Create(arg1 + " " + arg2 + " " + arg3);
            });
        ...
        public void TestHookReturnsEnumerable()
        {
            ...
            TestMutation(
                ...
                query: $@"
                    mutation {{
                        manualMutation({BuildArguments("Test1", "Test2", "Test3")}) {{
                            payload {{
                                people {{
                                    id
                                    payload {{
            ...
            afterSave.HasBeenCalledOnce();
            manualMutation.HasBeenCalledOnce(arg2: s => s == "Test1", arg3: s => s == "Test2", arg4: s => s == "Test3");
        }
