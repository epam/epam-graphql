...
namespace Epam.GraphQL.Tests
{
    public class BaseMutationTests : BaseTests
    {
        ...
        public new void SetUp()
        {
            ...
            DataContext.Convert(Arg.Any<IQueryable<QueryableExtensions.KeyValue<int, PersonSettings>>>())
            ...
            DataContext.Convert(Arg.Any<IQueryable<QueryableExtensions.KeyValue<int, Proxy<PersonSettings>>>>())
